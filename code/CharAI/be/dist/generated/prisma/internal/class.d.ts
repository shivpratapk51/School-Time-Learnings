 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.allCharacters`: Exposes CRUD operations for the **allCharacters** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more AllCharacters
      * const allCharacters = await prisma.allCharacters.findMany()
      * ```
      */
    get allCharacters(): Prisma.allCharactersDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
